    ...
    <>
        ...
        <Container>
          <Grid container spacing={2} columns={16}>
            <Grid item xs={16} sm={8}>
              ...
              >
                <Card
                  sx={{ borderRadius: "20px", border: "2px solid #d90429" }}
                >
                  <CardMedia
                    component="img"
                  ...
                  >
                    <Stack alignItems="baseline" gap={4} pl={5} py={3}>
                      ...
                      >
                        ...
                        >
                          <Typography
                            sx={{ fontSize: isSmallScreen ? "16px" : "22px" }}
                          >
                            {details?.vote_average &&
                              details.vote_average.toFixed(1) * 10}
                          </Typography>
      ...
      <Box sx={{ my: 2 }}>
        <Container sx={{ pb: 10 }}>
          <Typography
            variant={isSmallScreen ? "h6" : "h4"}
            sx={{ textTransform: "uppercase", mt: 10 }}
          >
            Cast
          </Typography>
          ...
          <Stack
            mt={5}
            mb={10}
            sx={{ display: "flex", flexDirection: "row", overflowX: "scroll" }}
            gap={5}
          >
            {cast?.length === 0 && <Typography>No Cast Found</Typography>}
            {cast &&
              cast.map((item) => (
                    ...
                    {item?.profile_path === null ? (
                      ...
                      <>
                        ...
                        <CardContent>
                          <Typography sx={{ textAlign: "center" }}>
                            {item?.name}{" "}
                            <span style={{ color: "indigo" }}>as</span>{" "}
                            {item?.character}
                          </Typography>
                        </CardContent>
                      </>
          ...
          <Box>
            <Typography variant={isSmallScreen ? "h6" : "h4"} sx={{ mb: 5 }}>
              Videos
            </Typography>
            <Box>
              <VideoCompo id={video?.key} />
              <Stack
                sx={{ mt: 5, mb: 5, overflowX: "scroll" }}
                display={"flex"}
                flexDirection={"row"}
                gap={5}
                alignItems={
                  videos && videos.length > 3 ? "flex-start" : "center"
                }
                justifyContent={
                  videos && videos.length > 3 ? "flex-start" : "center"
                }
              >
                {videos &&
                  videos.map((item) => (
                    <Card
                      key={item?.id}
                      sx={{ minWidth: "350px", textAlign: "center" }}
                    >
                      <CardMedia>
